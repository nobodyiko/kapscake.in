                    ...
                    <p><?php if ( $is_active ) : ?>
                            ...
                            <?php else: ?>
								<?php if ( empty( $purchase_code ) ) : ?>
									<?php
										echo '<strong>' . __( 'Please activate your theme license to update theme. ', 'thim-core' ) . '</strong>';
										// Go to page theme license
										echo '<a href="' . esc_url( add_query_arg( array( 'page' => 'thim-license', 'thim_redirect' => urlencode( $link_check ) ), admin_url( 'admin.php' ) ) ) . '" class="button-link">' . __( 'Activate now.', 'thim-core' ) . '</a>';
									?>
								<?php else: ?>
