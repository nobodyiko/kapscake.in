...
class Thim_Ekit_Widget_Post_Navigation extends Widget_Base {
	...
	public function render() {
		...
		if ( 'yes' === $settings['show_arrow'] ) {
			$prev_arrow = '<span class="thim-ekit-single-post__navigation__arrow thim-ekit-single-post__navigation__arrow--prev">' . $prev_icon_html . '<span class="elementor-screen-only">' . esc_html__( 'Prev', 'thim-elementor-kit' ) . '</span></span>';
			$next_arrow = '<span class="thim-ekit-single-post__navigation__arrow thim-ekit-single-post__navigation__arrow--next">' . $next_icon_html . '<span class="elementor-screen-only">' . esc_html__( 'Next', 'thim-elementor-kit' ) . '</span></span>';
		}
		...
		<div class="thim-ekit-single-post__navigation">
			<div class="thim-ekit-single-post__navigation__prev thim-ekit-single-post__navigation__link">
				<?php previous_post_link( '%link', $prev_arrow . '<span class="thim-ekit-single-post__navigation__link__content">' . wp_kses_post( $prev_label ) . wp_kses_post( $prev_title ) . '</span>', true, '' ); ?>
			</div>

			<div class="thim-ekit-single-post__navigation__next thim-ekit-single-post__navigation__link">
				<?php next_post_link( '%link', '<span class="thim-ekit-single-post__navigation__link__content">' . wp_kses_post( $next_label ) . wp_kses_post( $next_title ) . '</span>' . $next_arrow, true, '' ); ?>
			</div>
		</div>
